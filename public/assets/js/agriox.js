(function ($) {
  ...
  if ($(".range-slider-price").length) {
    ...
    function thmSwiperInit() {
        const swiperElements = document.querySelectorAll(".thm-swiper__slider");
        swiperElements.forEach(swiperElement => new Swiper(swiperElement, JSON.parse('{"spaceBetween": 100, "slidesPerView": 5, "autoplay": {"delay": 5000}, "breakpoints": {"0": {"spaceBetween": 20, "slidesPerView": 1}, "375": {"spaceBetween": 20, "slidesPerView": 1}, "575": {"spaceBetween": 20, "slidesPerView": 2}, "767": {"spaceBetween": 30, "slidesPerView": 3}, "991": {"spaceBetween": 40, "slidesPerView": 4}, "1199": {"spaceBetween": 40, "slidesPerView": 5}}}')));
    }
