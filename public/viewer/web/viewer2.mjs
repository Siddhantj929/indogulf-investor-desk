...
const PDFViewerApplication = {
    ...
    async run(config) {
        ...
        file = window.location.origin + "/pdfs/" + params.get("file");
...
const pdfjsVersion = "4.5.94";
const pdfjsBuild = "5b0e15ab1";
const AppConstants = {
